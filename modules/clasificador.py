...
class Clasificador():
    ...
    def __entrenar_clasificador(self):
        ...
        X_train, X_test, y_train, y_test = train_test_split(self.word_vectors, self.y, test_size=0.2, shuffle=True, stratify=self.y, random_state=0) #agregué self. a y en stratify=y // eliminaré stratify
...
if __name__== "__main__":  
    ...
    with open('C:/Users/-/Desktop/Programacion Avanzada/Programaci-n-Avanzada/Sistema de Reclamos/src/data/clasificador_svm.pkl', 'wb') as archivo:
