...
class FieldOptions:
    ...
    def bibliography_styles_provider(self) -> aspose.words.fields.IBibliographyStylesProvider:
        ...
        the :class:`FieldBibliography` and :class:`FieldCitation` fields."""
        ...
...
class FormField(aspose.words.SpecialChar):
    ...
    def set_text_input_value(self, new_value: object) -> None:
        ...
        The :attr:`FormField.text_input_default` value is applied if *newValue* is``None``."""
        ...
...
class IBibliographyStylesProvider:
    ...
    the  :class:`FieldBibliography` and :class:`FieldCitation` fields when they're updated."""
    
    def get_style(self, style_file_name: str) -> io.BytesIO:
        """Returns bibliography style.
        
        :param style_file_name: The bibliography style file name.
        :returns: The io.BytesIO with bibliography style XSLT stylesheet.
...
class FieldIfComparisonResult(Enum):
...
class FieldType(Enum):
    ...
    :class:`aspose.words.drawing.Shape` object, but for some documents, where a control does
...
class FieldUpdateCultureSource(Enum):
...
class MergeFieldImageDimensionUnit(Enum):
...
class TextFormFieldType(Enum):
    ...
    the :attr:`FormField.text_input_default` property."""
    CALCULATED: int
