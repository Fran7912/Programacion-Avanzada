...
class HtmlFixedSaveOptions(aspose.words.saving.FixedPageSaveOptions):
    ...
    def id_prefix(self) -> str:
        ...
        :raises RuntimeError (Proxy error(ArgumentException)): The value does not meet the requirements specified above."""
        ...
...
class ImageSaveOptions(aspose.words.saving.FixedPageSaveOptions):
    ...
    def page_layout(self) -> aspose.words.saving.MultiPageLayout:
        ...
        Use one of the factory methods of :class:`MultiPageLayout` to configure this property.
        
        For :attr:`aspose.words.SaveFormat.TIFF` the default value is :meth:`MultiPageLayout.tiff_frames`.
        For other formats the default value is :meth:`MultiPageLayout.single_page`.
        
        This property has effect only when saving to the following formats:
        :attr:`aspose.words.SaveFormat.JPEG`, :attr:`aspose.words.SaveFormat.GIF`, :attr:`aspose.words.SaveFormat.PNG`,
        :attr:`aspose.words.SaveFormat.BMP`, :attr:`aspose.words.SaveFormat.TIFF`, :attr:`aspose.words.SaveFormat.WEB_P`"""
        ...
...
class MarkdownSaveOptions(aspose.words.saving.TxtSaveOptionsBase):
    ...
    def resource_saving_callback(self) -> aspose.words.saving.IResourceSavingCallback:
        ...
        When you specify both :attr:`MarkdownSaveOptions.image_saving_callback` and :attr:`MarkdownSaveOptions.resource_saving_callback`,
        then first is called :attr:`MarkdownSaveOptions.resource_saving_callback`. However, note it is not necessary to have both
        implementations, as :class:`ImageSavingArgs` is actually a subset of :class:`ResourceSavingArgs`."""
        ...
    ...
    def office_math_export_mode(self) -> aspose.words.saving.MarkdownOfficeMathExportMode:
        ...
        Default value is :attr:`MarkdownOfficeMathExportMode.TEXT`."""
        ...
    ...
    def export_as_html(self) -> aspose.words.saving.MarkdownExportAsHtml:
        ...
        Default value is :attr:`MarkdownExportAsHtml.NONE`."""
        ...
    ...
    def empty_paragraph_export_mode(self) -> aspose.words.saving.MarkdownEmptyParagraphExportMode:
        ...
        Default value is :attr:`MarkdownEmptyParagraphExportMode.EMPTY_LINE`."""
        ...
...
class MultiPageLayout:
    ...
    @staticmethod
    def vertical(vertical_gap: float) -> aspose.words.saving.MultiPageLayout:
        """Creates a layout where all specified pages are rendered vertically one below the other in a single output.
        
        :param vertical_gap: The vertical gap between pages in points."""
        ...
    
    @staticmethod
    def horizontal(horizontal_gap: float) -> aspose.words.saving.MultiPageLayout:
        """Creates a layout in which all specified pages are rendered horizontally side by side,
        left to right, in a single output.
        
        :param horizontal_gap: The horizontal gap between pages in points."""
        ...
    
    @staticmethod
    def grid(columns: int, horizontal_gap: float, vertical_gap: float) -> aspose.words.saving.MultiPageLayout:
        ...
        :param horizontal_gap: The horizontal gap between columns in points.
        :param vertical_gap: The vertical gap between rows in points.
        :raises RuntimeError (Proxy error(ArgumentOutOfRangeException)): Thrown if *columns* is less than or equal to zero."""
        ...
    
    @staticmethod
    def tiff_frames() -> aspose.words.saving.MultiPageLayout:
    ...
    @staticmethod
    def single_page() -> aspose.words.saving.MultiPageLayout:
    ...
    def back_color(self) -> aspose.pydrawing.Color:
        ...
        The default is aspose.pydrawing.Color.empty."""
        ...
...
class PdfSaveOptions(aspose.words.saving.FixedPageSaveOptions):
    ...
    def render_choice_form_field_border(self) -> bool:
        ...
        Control and legacy Drop-Down Form Field when :attr:`PdfSaveOptions.preserve_form_fields` option is enabled.
    ...
    def attachments_embedding_mode(self) -> aspose.words.saving.PdfAttachmentsEmbeddingMode:
        ...
        Default value is :attr:`PdfAttachmentsEmbeddingMode.NONE` and attachments are not embedded.
        
        PDF/A-1, PDF/A-2 and regular PDF/A-4 (not PDF/A-4f) standards do not allow embedded files.
        :attr:`PdfAttachmentsEmbeddingMode.NONE` value will be used automatically."""
        ...
...
class ResourceSavingArgs:
    ...
    def resource_file_name(self) -> str:
        ...
        *Aspose.Words.\<document guid\>.\<image number\>.\<extension\>*.
        ...
        Aspose.Words determines the path for saving and the value of the ``src`` attribute for writing
        to fixed page HTML, SVG or Markdown using the document file name, the :attr:`HtmlFixedSaveOptions.resources_folder`
        or :attr:`SvgSaveOptions.resources_folder` and :attr:`HtmlFixedSaveOptions.resources_folder_alias`
        or :attr:`SvgSaveOptions.resources_folder_alias` or :attr:`MarkdownSaveOptions.images_folder` or
        :attr:`MarkdownSaveOptions.images_folder_alias` properties.
    ...
    def resource_file_uri(self) -> str:
        ...
        :attr:`HtmlFixedSaveOptions.resources_folder`
        :attr:`SvgSaveOptions.resources_folder`
        :attr:`MarkdownSaveOptions.images_folder`
        :attr:`HtmlFixedSaveOptions.resources_folder_alias`
        :attr:`SvgSaveOptions.resources_folder_alias`
        :attr:`MarkdownSaveOptions.images_folder_alias`"""
        ...
...
class TxtSaveOptions(aspose.words.saving.TxtSaveOptionsBase):
    ...
    def office_math_export_mode(self) -> aspose.words.saving.TxtOfficeMathExportMode:
        """Specifies how OfficeMath will be written to the output file.
        Default value is :attr:`TxtOfficeMathExportMode.TEXT`."""
        ...
...
class MarkdownEmptyParagraphExportMode(Enum):
    ...
    MARKDOWN_HARD_LINE_BREAK: int
    
    """Don't export empty paragraphs."""
    NONE: int
    

class MarkdownExportAsHtml(Enum):
    """Allows to specify the elements to be exported to Markdown as raw HTML."""
    ...
    If this flag is set, then related :attr:`MarkdownExportAsHtml.NON_COMPATIBLE_TABLES` flag will be ignored."""
    TABLES: int
    ...
    If related :attr:`MarkdownExportAsHtml.TABLES` flag is set, then this flag will be ignored."""
    NON_COMPATIBLE_TABLES: int
...
class MarkdownOfficeMathExportMode(Enum):
...
class PdfAttachmentsEmbeddingMode(Enum):
...
class TxtOfficeMathExportMode(Enum):
    """Specifies how Aspose.Words exports OfficeMath to :attr:`aspose.words.SaveFormat.TEXT`."""
