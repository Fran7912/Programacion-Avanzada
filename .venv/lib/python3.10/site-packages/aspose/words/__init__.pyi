...
class Document(aspose.words.DocumentBase):
    ...
    * The formatting attributes of each node can be changed via the properties of that node.
    ...
    @overload
    def extract_pages(self, index: int, count: int, options: aspose.words.PageExtractOptions) -> aspose.words.Document:
        """Returns the :class:`Document` object representing the specified range of pages and the given page extract options.
...
class DocumentBuilder:
    ...
    @overload
    def insert_group_shape(self, shapes: List[aspose.words.drawing.ShapeBase]) -> aspose.words.drawing.GroupShape:
    ...
    @overload
    def insert_group_shape(self, left: float, top: float, width: float, height: float, shapes: List[aspose.words.drawing.ShapeBase]) -> aspose.words.drawing.GroupShape:
    ...
    @overload
    def insert_chart(self, chart_type: aspose.words.drawing.charts.ChartType, width: float, height: float, chart_style: aspose.words.drawing.charts.ChartStyle) -> aspose.words.drawing.Shape:
        """Inserts an chart object into the document and scales it to the specified size.
        ...
        :param chart_style: The style of the inserted chart.
    ...
    @overload
    def insert_chart(self, chart_type: aspose.words.drawing.charts.ChartType, horz_pos: aspose.words.drawing.RelativeHorizontalPosition, left: float, vert_pos: aspose.words.drawing.RelativeVerticalPosition, top: float, width: float, height: float, wrap_type: aspose.words.drawing.WrapType, chart_style: aspose.words.drawing.charts.ChartStyle) -> aspose.words.drawing.Shape:
        """Inserts an chart object into the document and scales it to the specified size.
    ...
    def insert_forms_2_ole_control(self, forms_2_ole_control: aspose.words.drawing.ole.Forms2OleControl) -> aspose.words.drawing.Shape:
        """Inserts :class:`aspose.words.drawing.ole.Forms2OleControl` object into current position.
        
        :returns: :class:`aspose.words.drawing.Shape` object that contains passed :class:`aspose.words.drawing.ole.Forms2OleControl`"""
        ...
...
class FontSubstitutionWarningInfo(aspose.words.WarningInfo):
    """Contains information about a font substitution warning that Aspose.Words issued during document loading or saving."""
    
    @property
    def reason(self) -> aspose.words.FontSubstitutionReason:
        """Font substitution reason."""
        ...
    
    @property
    def requested_family_name(self) -> str:
        """Requested font family name."""
        ...
    
    @property
    def requested_bold(self) -> bool:
    ...
    @property
    def resolved_font(self) -> aspose.words.fonts.PhysicalFontInfo:
        """Resolved font."""
        ...
...
class IDocumentConverterPlugin:
    ...
    def convert(self, input_stream: io.BytesIO, load_options: aspose.words.loading.LoadOptions, output_stream: io.BytesIO, save_options: aspose.words.saving.SaveOptions) -> None:
    ...
    def convert_to_images(self, input_stream: io.BytesIO, load_options: aspose.words.loading.LoadOptions, save_options: aspose.words.saving.SaveOptions) -> List[io.BytesIO]:
...
class IDocumentMergerPlugin:
    ...
    def merge(self, output_stream: io.BytesIO, input_streams: List[io.BytesIO], load_options: List[aspose.words.loading.LoadOptions]) -> None:
...
class IDocumentProcessorPlugin:
    ...
    def load(self, input_stream: io.BytesIO, load_options: aspose.words.loading.LoadOptions) -> None:
        """Load the document using the specified load options.
        
        :param input_stream: The input stream.
        :param load_options: The document load options. Can be ``None``, in this case the document is loaded with default load options."""
        ...
    
    def append(self, input_stream: io.BytesIO, load_options: aspose.words.loading.LoadOptions) -> None:
    ...
    def save(self, output_stream: io.BytesIO, save_options: aspose.words.saving.SaveOptions) -> None:
        """Save the document loaded by :meth:`IDocumentProcessorPlugin.load` method to the output stream using the specified save options.
        
        :param output_stream: The output stream.
        :param save_options: The save options.
        
        If the specified output format is image, only the first page image is saved to the output stream.
        If the specified save format is not natively supported by the plugin (requires loading to :class:`Document`),
        method throws an exception."""
        ...
    
    def to_pages(self, save_options: aspose.words.saving.FixedPageSaveOptions) -> List[io.BytesIO]:
        """Saves each page of the document loaded by :meth:`IDocumentProcessorPlugin.load` method using the specified fixed page save options."""
        ...
    
    def set_text_watermark(self, text_watermark: str, text_watermark_options: aspose.words.TextWatermarkOptions) -> None:
        """Adds text watermark on each page of the document loaded by :meth:`IDocumentProcessorPlugin.load` method.
        
        :param text_watermark: Text used as a watermark.
        :param text_watermark_options: Text watermark options."""
        ...
    
    def set_image_watermark(self, image_watermark: io.BytesIO, image_watermark_options: aspose.words.ImageWatermarkOptions) -> None:
        """Adds image watermark on each page of the document loaded by :meth:`IDocumentProcessorPlugin.load` method.
        
        :param image_watermark: Image used as a watermark.
        :param image_watermark_options: Image watermark options."""
        ...
    
    def to_document(self) -> aspose.words.Document:
        """Parses the document loaded by :meth:`IDocumentProcessorPlugin.load` method into :class:`Document` object."""
        ...
...
class IIndexFilter:
    ...
    def should_skip_index(self, index: int) -> bool:
        ...
        :returns: ``True`` if the item should be skipped; otherwise, ``False``."""
        ...
...
class Style:
    ...
    def as_table_style(self) -> aspose.words.TableStyle:
        """Cast Style to :class:`TableStyle`."""
        ...
...
class UnsupportedEncryptionException(RuntimeError):
...
class Watermark:
    ...
    @overload
    def set_image(self, image_stream: io.BytesIO, options: aspose.words.ImageWatermarkOptions) -> None:
        ...
...
class FontSubstitutionReason(Enum):
